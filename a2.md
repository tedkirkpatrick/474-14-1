...
Diagram of the system (Courtesy of Izaak):

<img src="images/a2-structure.png" class="img-responsive" alt="Structure of Assignment 2 system">

<div class="well">Note: The first version of this assignment
inadvertently included references to Amazon's CloudFront system. That
is not part of this assignment and has been removed.</div>
